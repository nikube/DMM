...
-- Portable syntax only; run_sql() tolerates "column already exists" on replay.
ALTER TABLE llx_dmm_module ADD COLUMN git_host VARCHAR(20) DEFAULT 'github';
ALTER TABLE llx_dmm_module ADD COLUMN git_base_url VARCHAR(200) DEFAULT NULL;
ALTER TABLE llx_dmm_module ADD COLUMN subdir VARCHAR(200) DEFAULT NULL;
